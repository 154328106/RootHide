...
+ (NSString *)changelogText
{
    return @"Dopamine 3.0.9 更新日志\n\n"
        @"• 修复在 iOS 18.4+ 上移除越狱时，越狱应用未从主屏幕移除的问题\n\n"
        @"• 当设备已越狱时，从设置中移除“移除越狱”按钮，因其不够稳定；现在该按钮仅在 TrollStore 安装且未越狱时显示。非 TrollStore 安装唯一支持的卸载流程现在是重启并在启用“移除越狱”开关的情况下重新越狱\n\n"
        @"• 修复应用设置中“隐藏越狱”说明不显示的问题 [2.5测试版回归]\n\n"
        @"• 改进应用设置中“隐藏越狱”的说明，以减少对其功能的混淆，并强调用户应自行承担使用风险\n";
}
