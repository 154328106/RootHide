...
-(id)initWithImage:(UIImage *)image subtitles:(NSArray<NSAttributedString *> *)subtitles {
    if (self = [super init]) {
        ...
        [NSLayoutConstraint activateConstraints:@[
            ...
            [cardBg.topAnchor constraintEqualToAnchor:self.topAnchor constant:32],
            [cardBg.bottomAnchor constraintEqualToAnchor:self.bottomAnchor constant:-32],
            ...
            [stackView.topAnchor constraintEqualToAnchor:self.topAnchor constant:55],
            [stackView.bottomAnchor constraintEqualToAnchor:self.bottomAnchor constant:-55],
        ]];
